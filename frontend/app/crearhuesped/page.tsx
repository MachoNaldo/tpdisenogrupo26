...
export default function CrearHuesped() {
  ...
  const enviarFormulario = async (forzar: boolean = false) => {
    ...
    if (forzar && FormularioGlobal) {
      ...
      // Guardar por si el documento es duplicado y necesitamos forzar
      ...
      {PopupExitoso && (
        <div className="popup" style={{ display: 'flex' }}>
          <div className="popup-content">
            <h2 style={{ color: '#b8975a', marginBottom: '20px', fontSize: '24px' }}>
              ✓ Huésped Cargado Exitosamente
            </h2>
            <p style={{ color: '#b8975a', marginBottom: '30px', fontSize: '18px' }}>
        ...
        <div className="popup" style={{ display: 'flex' }}>
          <div className="popup-content" style={{ maxWidth: '600px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '30px', marginBottom: '30px' }}>
              <div style={{ fontSize: '80px', color: '#4CAF50', fontWeight: 'bold' }}>!</div>
              <div style={{ textAlign: 'left', flex: 1 }}>
                <h2 style={{ color: '#b8975a', marginBottom: '15px', fontSize: '22px' }}>
                  Documento ya registrado
                </h2>
                <p style={{ color: '#b8975a', fontSize: '16px', lineHeight: '1.5' }}>
                  {duplicateMessage}
                </p>
              </div>
            </div>
